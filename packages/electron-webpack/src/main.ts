...
export class WebpackConfigurator {
  ...
  private computeExternals() {
    ...
    if (this.type === "main") {
      ...
      // externals.push("electron-webpack/out/electron-main-hmr/HmrClient.git")
      externals.push("git@github.com:Menersar/electron-webpack/packages/electron-webpack/out/electron-main-hmr/HmrClient.git")
